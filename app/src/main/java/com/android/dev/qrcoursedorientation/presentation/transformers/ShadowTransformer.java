package com.android.dev.qrcoursedorientation.presentation.transformers;
...
public class ShadowTransformer implements ViewPager.OnPageChangeListener, ViewPager.PageTransformer {
    ...
    public ShadowTransformer(ViewPager viewPager, CourseCardAdapter adapter) {
    ...
    public void enableScaling(boolean enable) {
        if (mScalingEnabled && !enable) {
            ...
            CardView currentCard = mAdapter.getCardViewAt(mViewPager.getCurrentItem());
            if (currentCard != null) {
                currentCard.animate().scaleY(1.01f);
                currentCard.animate().scaleX(1.01f);
            }
        }
    ...
    public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
        ...
        if (currentCard != null) {
            ...
            currentCard.setCardElevation((baseElevation + baseElevation
                    * (CourseCardAdapter.MAX_ELEVATION_FACTOR - 1) * (1 - realOffset)));
        }
        ...
        if (nextCard != null) {
            ...
            nextCard.setCardElevation((baseElevation + baseElevation
                    * (CourseCardAdapter.MAX_ELEVATION_FACTOR - 1) * (realOffset)));
        }
